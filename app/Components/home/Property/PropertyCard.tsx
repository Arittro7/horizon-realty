  ...
  return (
    <div className="bg-white overflow-hidden group rounded-lg cursor-pointer shadow-lg">
      <div className="relative">
        ...
        />
        <h1 className="px-6 absolute bottom-4 left-4 py-1.5 text-sm bg-rose-700 w-fit text-white rounded-lg">
          <span className="text-base font-bold">${property.price} / mo</span>
        </h1>
        <div className="flex items-center space-x-1 px-6 absolute top-4 left-4 py-2 text-sm bg-orange-500 w-fit text-white rounded-md font-bold">
          <MdElectricBolt/>
          <span>Featured</span>
        </div>
      </div>
      <div className="p-5">
        ...
        <div className="flex items-center mt-6 justify-between  lg:w-[70%]">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="text-xs text-gray-600"> {property.size} sq</p>
          </div>          
        </div>
        <div className="w-full h-[1.2px] my-4 bg-gray-500 opacity-15"></div>
        <div className="flex items-center justify-between px-3">
          <h1 className="text-xl font-semibold text-gray-600">For Rent</h1>
